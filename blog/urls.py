...
urlpatterns = [
    ...
    path('network-graph/<str:username>/', social_views.network_graph_view, name='network-graph-view'),
    path('api/network-graph/<str:username>/', social_views.network_graph_data, name='network-graph-data'),
